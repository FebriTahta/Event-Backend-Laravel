      ...
      <section class="dark:bg-jacarta-800 bg-light-base relative pb-12 pt-28">
        ...
        <div class="container">
          <div class="text-center">
            <h2 class="font-display text-jacarta-700 mb-2 text-4xl font-medium dark:text-white">NFT Funny Cat</h2>
            <div class="mb-8">
              <span class="text-jacarta-400 text-sm font-bold">Created by</span>
              <a href="user.html" class="text-accent text-sm font-bold">051_Hart</a>
            </div>
            ...
            >
              ...
              >
                ...
                <div class="text-2xs dark:text-jacarta-400 font-medium tracking-tight">Items</div>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <div class="text-2xs dark:text-jacarta-400 font-medium tracking-tight">Owners</div>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <div class="text-2xs dark:text-jacarta-400 font-medium tracking-tight">Floor Price</div>
              </a>
              <a href="#" class="border-jacarta-100 w-1/2 rounded-r-xl py-4 hover:shadow-md sm:w-32">
                ...
                <div class="text-2xs dark:text-jacarta-400 font-medium tracking-tight">Volume Traded</div>
              </a>
            </div>
                          ...
                          <div class="modal-body">
                            <div class="accordion" id="accordionProps">
                              <div class="accordion-item dark:border-jacarta-600 border-jacarta-100 border-b">
                                <h2 class="accordion-header" id="prop-heading-1">
                                  <button
                                ...
                                >
                                  <div class="accordion-body px-2 pb-4">
                                    <div class="flex flex-col">
                                      <button
                                        class="dark:hover:bg-jacarta-600 dark:text-jacarta-200 hover:bg-jacarta-50 flex items-center justify-between rounded-xl px-4 py-2"
                                      >
                                        <span>Red</span>
                                        <span>14</span>
                                      </button>
                              ...
                              <div class="accordion-item dark:border-jacarta-600 border-jacarta-100 border-b">
                                <h2 class="accordion-header" id="prop-heading-2">
                                  <button
                                    class="accordion-button collapsed dark:bg-jacarta-700 font-display text-jacarta-700 relative flex w-full items-center justify-between bg-white px-6 py-5 dark:text-white"
                                    type="button"
                                    data-bs-toggle="collapse"
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="prop-heading-3">
                                  <button
                                    class="accordion-button collapsed dark:bg-jacarta-700 font-display text-jacarta-700 relative flex w-full items-center justify-between bg-white px-6 py-5 dark:text-white"
                                    type="button"
                                    data-bs-toggle="collapse"
                      ...
                      <div class="dropdown mb-4 cursor-pointer px-5 pt-2">
                        ...
                        >
                          <span class="font-display flex items-center">
                            <img src="img/chains/ETH.png" alt="eth" class="mr-2 h-5 w-5 rounded-full" />
                            ETH
                          </span>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          ...
                          >
                            <span class="flex items-center">
                              <img src="img/chains/FLOW.png" alt="flow" class="mr-2 h-5 w-5 rounded-full" />
                              FLOW
                            </span>
                          </button>
                          ...
                          >
                            <span class="flex items-center">
                              <img src="img/chains/FUSD.png" alt="fusd" class="mr-2 h-5 w-5 rounded-full" />
                              FUSD
                            </span>
                          </button>
                          ...
                          >
                            <span class="flex items-center">
                              <img src="img/chains/XTZ.png" alt="xtz" class="mr-2 h-5 w-5 rounded-full" />
                              XTZ
                            </span>
                          </button>
                          ...
                          >
                            <span class="flex items-center">
                              <img src="img/chains/DAI.png" alt="dai" class="mr-2 h-5 w-5 rounded-full" />
                              DAI
                            </span>
                          </button>
                          ...
                          >
                            <span class="flex items-center">
                              <img src="img/chains/RARI.png" alt="rari" class="mr-2 h-5 w-5 rounded-full" />
                              RARI
                            </span>
                          </button>
                        </div>
